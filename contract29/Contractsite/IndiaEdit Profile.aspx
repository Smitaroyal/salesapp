...
<head runat="server">
    ...
    <script>
        ...
        $(function () {
            $("#pdobdatepicker,#sdobdatepicker,#sp1dobdatepicker,#sp2dobdatepicker,#sp3dobdatepicker,#sp4dobdatepicker,#checkindatedatepicker,#checkoutdatedatepicker,#tourdatedatepicker").datepicker({
                changeMonth: true,
                changeYear: true,
                yearRange: "-100:+0",
                dateFormat: 'yy-mm-dd'
...
<body>
                    ...
                    <div style="background-color: #e9e9e9; padding-top: 10px; padding-left: 5px; padding-right: 5px;">
                        ...
                        <table style="width: 57%;">
                            <tbody id="hidden1">
                                <tr>
                                    <td>
                                        <asp:Label ID="Label11" runat="server" Font-Size="Medium" Text="Label">Choose Source</asp:Label></td>
                                    <td>
                        ...
                        <table style="width: 100%;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <asp:Label ID="Label21" runat="server" Text="Label">Mobile Number</asp:Label></td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Label ID="Label22" runat="server" Text="Label">Alternate Number</asp:Label></td>
                                    <td>
                                        <asp:DropDownList ID="primaryalternateDropDownList" Font-Size="Small" Style="width: 70px; height: 25px" runat="server"></asp:DropDownList>&nbsp;<asp:TextBox ID="palternateTextBox" Font-Size="Small" Style="width: 95px; height: 20px" runat="server" Enabled="True"></asp:TextBox></td>
                                    <td>
                        ...
                        <table style="width: 100%;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <asp:Label ID="Label29" runat="server" Text="Label">Mobile Number</asp:Label></td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Label ID="Label30" runat="server" Text="Label">Alternate Number</asp:Label></td>
                                    <td>
   ...
   <!-- on load marketing,agents ,Toname,managers -->
     <script>
        $(document).ready(function(){
...
<!-- end -->
    ...
    <!-- on change loading venue group,sales rep , managers -->
    <script>
    ...
    <script>
        $(document).ready(function () {
            // on load  loading salutations for primary
            $.ajax({
            ...
            // on load loading nationality for primary
    ...
    <script>
        $(document).ready(function () {
            ...
            // on load primary all country code alternate on country
         ...
         //   alert(country);
            ...
            // loading phone data for primary
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong load email primary");
                }
   ...
   <!----------------------------------XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX--------------------------------------------->
    <!-- Secondary profile -->
     <script>
        $(document).ready(function () {
            // on load  loading salutations for secondary
            $.ajax({
                ...
                error: function () {
                    alert("wrong  loading salutations for secondary");
                }
            ...
            // on load loading nationality for secondary
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong loading nationality for secondary");
                }
            });
            // end ///


            //on load country for secondary
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong  load country for secondary ");
                }
            });
            ...
            // on load secondary country code primary on country
            ...
            // loading phone data for secondary
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong loading phone data for secondary");
                }
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong load email secondary");
                }
...
<!------------------------------------------------- end of other details--------------------------------------------------------------->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // on load  loading salutations for sub profile 1
            $.ajax({
                ...
                error: function () {
                    alert("wrong  loading salutations for sub profile 1");
                }
            ...
            // on load loading nationality for sub profile 1
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong loading nationality for sub profile 1");
                }
            });
            // end ///


            //on load country for sub profile 1
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong  load country for sub profile 1 ");
                }
            });
            ...
            // loading phone data for sub profile 1////
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong loading phone data for sub profile 1");
                }
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong load email sub profile 1");
                }
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // on load  loading salutations for sub profile 2
            $.ajax({
                ...
                error: function () {
                    alert("wrong  loading salutations for sub profile 2");
                }
            ...
            // on load loading nationality for sub profile 2
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong loading nationality for sub profile 2");
                }
            });
            // end ///


            //on load country for sub profile 2
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong  load country for sub profile 2 ");
                }
            });
            ...
            //end//
            // loading phone data for sub profile  2
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong loading phone data for sub profile  2");
                }
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong load email sub profile 2");
                }
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // on load  loading salutations for sub profile 3
            $.ajax({
                ...
                error: function () {
                    alert("wrong  loading salutations for sub profile 3");
                }
            ...
            // on load loading nationality for sub profile 3
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong loading nationality for sub profile 3");
                }
            });
            // end ///


            //on load country for sub profile 3
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong  load country for sub profile 3 ");
                }
            });
            ...
            // loading phone data for sub profile 3 
            ...
            $.ajax({
                ...
                error: function () {
                    alert("wrong loading phone data for sub profile 3");
                }
            ...
            // loading email for sub profile 3
            $.ajax({
                ...
                error: function () {
                    alert("wrong load email sub profile  3 ");
                }
    ...
    <!----------------------------------------------------------------------- Sub profile 4----------------------------------------------------->
     <script>
         ...
         $(document).ready(function () {
             ...
             // on load  loading salutations for sub profile 4
             $.ajax({
                 ...
                 error: function () {
                     alert("wrong  loading salutations for sub profile 4");
                 }
             ...
             // on load loading nationality for sub profile 4
             ...
             $.ajax({
                 ...
                 error: function () {
                     alert("wrong loading nationality for sub profile 4");
                 }
             });
             // end ///


             //on load country for sub profile 4
             ...
             $.ajax({
                 ...
                 error: function () {
                     alert("wrong  load country for sub profile 4 ");
                 }
             });
             ...
             // loading phone data for sub profile  4
             ...
             $.ajax({
                 ...
                 error: function () {
                     alert("wrong loading phone data for sub profile 4");
                 }
             ...
             // loading email for primary ,secondary sub profile  4
             $.ajax({
                 ...
                 error: function () {
                     alert("wrong load email sub profile 4");
                 }
