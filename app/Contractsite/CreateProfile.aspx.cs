      ...
      /*  DataSet ds14 = Queries.LoadCountryWithCode();
       ...
       /*     MaritalStatusDropDownList.Items.Add("");
        ...
        TextBox1.Text = DateTime.Today.ToString("yyyy/MM/dd");
            ...
            DataSet dsgift = Queries2.LoadGiftOption(office);
            giftoptionDropDownList.DataSource = dsgift;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       //display username
        ...
        if (exists == 0)
        {
            ...
            {
                int profile = Queries.InsertProfile(ProfileIDTextBox.Text, DateTime.Now, createdby, venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, memno1, membertype2, memno2, employmentstatus, maritalstatus, livingyrs,office,commentTextBox.Text,"");
                ...
                if (giftoptionDropDownList.SelectedIndex != 0)
                {
                    ...
                    int insert = Queries.InsertGiftOption(giftid, giftoptionDropDownList.SelectedItem.Text, vouchernoTextBox.Text, commentTextBox.Text, ProfileIDTextBox.Text, "");
                }
