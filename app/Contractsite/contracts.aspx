...
#myBtn:hover {
  background-color: #555;
   ...
   #cleft {
     ...
     #pan,#adhar,#yes,#yes1,#yess1,#yes2,#yess2,#remarks,#Points,#pnumb,#usddetails,#indiadetails {
         display: none;
     }
     body {
          ...
          <br />
           ...
           <!-- <tr>
            ...
            <tr>
                ...
                <td width="300px"><asp:DropDownList ID="DealDrawerDropDownList" runat="server" Width="200px" style="height: 25px"  ></asp:DropDownList></td>
            </tr> 
            <tr>
                <td width="300px"><asp:Label ID="Label89" runat="server" Text="Label">Payment Method</asp:Label></td>
                <td width="300px"><asp:DropDownList ID="PayMethodDropDownList" onchange="pay_method();" runat="server" Width="200px" style="height: 25px"></asp:DropDownList></td>
            </tr>
            <tr id="pnumb">
           ...
           <tr>
                ...
                <td width="300px"><asp:DropDownList ID="BPMDropDownList" runat="server" Width="200px" style="height: 25px"></asp:DropDownList></td>
            </tr>  
            <tr>
                  ...
                  <tr>
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:Button ID="Button2" runat="server" Text="Next Step" OnClientClick="return false;"  />
