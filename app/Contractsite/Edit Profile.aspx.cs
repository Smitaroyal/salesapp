...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
           ...
           // DataSet ds = Queries2.LoadProfileOnCreation(ProfileID);
            ...
            createddateTextBox.Text  = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Date_Of_Insertion"]).ToString("dd-MM-yyyy");
          ...
          //  primarytitleDropDownList.Items.Add(ds.Tables[0].Rows[0]["Profile_Primary_Title"].ToString());
            ...
            //pdobdatepicker.Text =  Convert.ToDateTime( ds.Tables[0].Rows[0]["Profile_Primary_DOB"]).ToString("dd-MM-yyyy");

            string deptt = ds.Tables[0].Rows[0]["Profile_Primary_DOB"].ToString();
            string datep1 = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Primary_DOB"]).ToString("dd-MM-yyyy");
           ...
           // secondarytitleDropDownList.Items.Add(ds.Tables[0].Rows[0]["Profile_Secondary_Title"].ToString());
            ...
            //sdobdatepicker.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Secondary_DOB"].ToString()).ToString("dd-MM-yyyy");

            string datep2 = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Secondary_DOB"]).ToString("dd-MM-yyyy");
          ...
          //  subprofile1titleDropDownList.Items.Add(ds.Tables[0].Rows[0]["Sub_Profile1_Title"].ToString());
            ...
            //sp1dobdatepicker.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["Sub_Profile1_DOB"]).ToString("dd-MM-yyyy");

            string datep3 = Convert.ToDateTime(ds.Tables[0].Rows[0]["Sub_Profile1_DOB"]).ToString("dd-MM-yyyy");
          ...
          //  subprofile2titleDropDownList.Items.Add(ds.Tables[0].Rows[0]["Sub_Profile2_Title"].ToString());
            ...
            //sp2dobdatepicker.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["Sub_Profile2_DOB"]).ToString("dd-MM-yyyy");

            string datep4 = Convert.ToDateTime(ds.Tables[0].Rows[0]["Sub_Profile2_DOB"]).ToString("dd-MM-yyyy");
         ...
         cityTextBox.Text = ds.Tables[0].Rows[0]["Profile_Address_city"].ToString();
            ...
            //checkindatedatepicker.Text = Convert.ToDateTime( ds.Tables[0].Rows[0]["Profile_Stay_Arrival_Date"]).ToString("dd-MM-yyyy");
            //checkoutdatedatepicker.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Stay_Departure_Date"]).ToString("dd-MM-yyyy");

            string datep5 = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Stay_Arrival_Date"]).ToString("dd-MM-yyyy");
            ...
            string datep6 = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Stay_Departure_Date"]).ToString("dd-MM-yyyy");
           ...
           // tourdatedatepicker.Text= Convert.ToDateTime( ds.Tables[0].Rows[0]["Tour_Details_Tour_Date"]).ToString("dd-MM-yyyy");

            string datep7 = Convert.ToDateTime(ds.Tables[0].Rows[0]["Tour_Details_Tour_Date"]).ToString("dd-MM-yyyy");
            ...
            oProfile_Primary_DOB = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Primary_DOB"].ToString()).ToString("dd-MM-yyyy");
            ...
            oProfile_Secondary_DOB = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Secondary_DOB"].ToString()).ToString("dd-MM-yyyy");
            ...
            oSub_Profile1_DOB = Convert.ToDateTime(ds.Tables[0].Rows[0]["Sub_Profile1_DOB"].ToString()).ToString("dd-MM-yyyy");
            ...
            oSub_Profile2_DOB = Convert.ToDateTime(ds.Tables[0].Rows[0]["Sub_Profile2_DOB"].ToString()).ToString("dd-MM-yyyy");
            ...
            oProfile_Stay_Arrival_Date = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Stay_Arrival_Date"].ToString()).ToString("dd-MM-yyyy");
            oProfile_Stay_Departure_Date = Convert.ToDateTime(ds.Tables[0].Rows[0]["Profile_Stay_Departure_Date"].ToString()).ToString("dd-MM-yyyy");
            ...
            oTour_Details_Tour_Date = Convert.ToDateTime(ds.Tables[0].Rows[0]["Tour_Details_Tour_Date"].ToString()).ToString("dd-MM-yyyy");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string primarydob = pdobdatepicker.Text;//Convert.ToDateTime(pdobdatepicker.Text).ToString("dd-MM-yyyy"); 
        string tprimarydob;
        if (primarydob == "")
        {
