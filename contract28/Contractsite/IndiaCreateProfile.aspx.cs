        ...
        try
        {
         ...
         //   string user = CreatedByTextBox.Text;
            ...
            if (exists == 0)
            {
                ...
                {
                    int profile = Queries.InsertProfile(ProfileIDTextBox.Text, DateTime.Now, createdby, venuecountry, venue, venuegroup, mktg, agents, agentcode, membertype1, memno1, membertype2, memno2, employmentstatus, maritalstatus, livingyrs, office, commentsTextBox.Text, mgr, photoidentity, card,"","");
                    string log1 = "Profile Details:" + " " + "Profile ID:" + ProfileIDTextBox.Text + "," + "Created date:" + createddateTextBox.Text + "," + CreatedByTextBox.Text + "," + "venue country:" + venuecountry + "," + "mktg prgm:" + mktg + "," + "Agent:" + agents + "," + "TO Name:" + agentcode + "," + "Manager:" + mgr + "," + "membertype1:" + membertype1 + "," + "memno1:" + memno1 + "," + "membertype2:" + membertype2 + "," + "memno2:" + memno2 + "," + "Employmentstatus:" + employmentstatus + "," + "Maritalstatus:" + maritalstatus + "," + "Living Yrs:" + livingyrs + "," + "Office:" + office + "," + "Comments:" + commentsTextBox.Text + "," + "Mgr:" + mgr + "," + "Photo Identity:" + photoidentity + "," + "Card Holder:" + card;
                    ...
                    int primary = Queries.InsertPrimaryProfile(primaryprofileid, primarytitle, primaryfname, primaylname, primarydob, primarynationality, primarycountry, ProfileIDTextBox.Text, primaryage, maledesgination, primarylanguage);

                    string log2 = "Primary details:" + " " + "primary id:" + primaryprofileid + "," + "title:" + primarytitle + "," + "Fname:" + primaryfname + "," + "Lname:" + primaylname + "," + "DOB:" + primarydob + "," + "nationality:" + primarynationality + "," + "Country:" + primarycountry + "," + "Profile ID:" + ProfileIDTextBox.Text + "Age:" + primaryage + "," + "Designation:" + maledesgination + "," + "Languages spoken:" + primarylanguage;
                    ...
                    int secondary = Queries.InsertSecondaryProfile(secondaryprofileid, secondarytitle, secondaryfname, secondarylname, secondarydob, secondarynationality, secondarycountry, ProfileIDTextBox.Text, secondaryage, femaledesignation, secondarylanguage);
                    string log3 = "secondary details:" + " " + "secondary id:" + secondaryprofileid + "," + "title:" + secondarytitle + "," + "Fname:" + secondaryfname + "," + "Lname:" + secondarylname + "," + "DOB:" + secondarydob + "," + "nationality:" + secondarynationality + "," + "Country:" + secondarycountry + "," + "Profiel ID:" + ProfileIDTextBox.Text + "Age:" + secondaryage + "," + "Designation:" + femaledesignation + "," + "Languages spoken:" + secondarylanguage;
                    ...
                    int subprofielid = Queries.InsertSub_Profile1(subprofile1id, sp1title, sp1fname, sp1lname, sp1dob, sp1nationality, sp1country, ProfileIDTextBox.Text, sp1age);
                    ...
                    int subprofielid2 = Queries.InsertSub_Profile2(subprofile2id, sp2title, sp2fname, sp2lname, sp2dob, sp2nationality, sp2country, ProfileIDTextBox.Text, sp2age);
                    ...
                    int subprofielid3 = Queries.InsertSub_Profile3(subprofile3id, sp3title, sp3fname, sp3lname, sp3dob, sp3nationality, sp3country, ProfileIDTextBox.Text, sp3age);
                    string log12 = "sub profile3 details:" + " " + "sp3 id:" + subprofile3id + "," + "title:" + sp3title + "," + "Fname:" + sp3fname + "," + "Lname:" + sp3lname + "," + "DOB:" + sp3dob + "," + "nationality:" + sp3nationality + "," + "Country:" + sp3country + "," + "Profiel ID:" + ProfileIDTextBox.Text;
                    int insertlog12 = Queries.InsertContractLogs_India(ProfileIDTextBox.Text, "", log12, user, DateTime.Now.ToString());

                    // insert into sub profile4

                    string subprofile4id = Queries.GetSubProfile4ID(office);
                    int subprofielid4 = Queries.InsertSub_Profile4(subprofile4id, sp4title, sp4fname, sp4lname, sp4dob, sp4nationality, sp4country, ProfileIDTextBox.Text, sp4age);
                    string log13 = "sub profile4 details:" + " " + "sp4 id:" + subprofile4id + "," + "title:" + sp4title + "," + "Fname:" + sp4fname + "," + "Lname:" + sp4lname + "," + "DOB:" + sp4dob + "," + "nationality:" + sp4nationality + "," + "Country:" + sp4country + "," + "Profiel ID:" + ProfileIDTextBox.Text;
                    int insertlog13 = Queries.InsertContractLogs_India(ProfileIDTextBox.Text, "", log13, user, DateTime.Now.ToString());


                    //  insert phone
                    string phid = Queries.GetPhoneID(office);
                    int phone = Queries.InsertPhone(phid, ProfileIDTextBox.Text, pcc, pmobile, paltrcc, palternate, scc, smobile, saltcc, salternate, sp1cc, sp1mobile, sp1altcc, sp1alternate, sp2cc, sp2mobile, sp2altccc, sp2alternate, sp3cc, sp3mobile, sp4cc, sp4mobile, sp3altccc, sp3alternate, sp4altccc, sp4alternate);
                    string log7 = "Phone Details:" + " " + "Phone id:" + phid + "," + "Profile id:" + ProfileIDTextBox.Text + "," + "Primary mobile:" + pcc + "" + pmobile + "," + "primary alternate:" + paltrcc + "" + palternate + "," + "Secondary mobile:" + scc + "" + smobile + "," + "Secondary alternate:" + saltcc + "" + salternate + "," + "Subprofile1 mobile:" + sp1cc + " " + sp1mobile + "," + "Subprofile1 alternate:" + sp1altcc + "" + sp1alternate + "," + "Subprofile2 mobile:" + sp2cc + "" + sp2mobile + "," + "subprofile2 alternate:" + sp2altccc + "" + sp2alternate + "," + "Subprofile3 mobile:" + sp3cc + "" + sp3mobile + "," + "subprofile3 alternate:" + sp3altccc + "" + sp3alternate + "," + "Subprofile4 mobile:" + sp4cc + "" + sp4mobile + "," + "subprofile4 alternate:" + sp4altccc + "" + sp4alternate;
                    ...
                    int email = Queries.InsertEmail(emid, ProfileIDTextBox.Text, pemail, semail, sp1email, sp2email, "", "", "", "", sp3email, "", sp4email, "");
                    string log8 = "Email Details:" + " " + "Email id:" + emid + "," + "profile id:" + ProfileIDTextBox.Text + "," + "Primary email:" + pemail + "," + "Secondary email:" + semail + "," + "Subprofile1 email:" + sp1email + "," + "subprofile2 email:" + sp2email + "," + "subprofile3 email:" + sp3email + "," + "subprofile4 email:" + sp4email;
          ...
          //  Response.Write("<script language =  javascript > window.location.href ='/WebSite5/production/Dashboard.aspx';</script>");
