...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
      ...
      if (String.Compare(oSub_Profile2_DOB, sp2dob) != 0)
       ...
       if (String.Compare(oSubprofile2_Alternate, sp2alternate) != 0)
        ...
        //update profile
        int updateprofile = Queries.UpdateProfile(profile, venuecountry, venue, venuegroup,  mktg,  agents,  agentcode, membertype1, memno1,  membertype2, memno2,  employmentstatus, maritalstatus, livingyrs,mgr,photoidentity,card,ProfileComments);
        ...
        int phone = Queries.UpdatePhone(profile, pcc, pmobile, paltrcc, palternate, scc, smobile, saltcc, salternate, sp1cc, sp1mobile, sp1altcc, sp1alternate, sp2cc, sp2mobile, sp2altccc, sp2alternate, sp3cc, sp3mobile, sp3altccc, sp3alternate, sp4cc, sp4mobile, sp4altccc, sp4alternate);
    ...
    public static string LoadSubProfile3Data()
    {
        ...
        while (reader.Read())
        {
            ...
            string dob = Convert.ToDateTime(reader["Sub_Profile3_DOB"]).ToString("yyyy-MM-dd");
    ...
    public static string LoadSubProfile3n4PhoneData()
    {
        ...
        while (reader.Read())
        {
            ...
            JSON += "[\"" + sub1pricc + "\",\"" + sub1prino + "\",\"" + sub1altcc + "\",\"" + sub1altno + "\",\"" + sub2pricc + "\",\"" + sub2prino + "\",\"" + sub2altcc + "\",\"" + sub2altno + "\",\"" + sub3pricc + "\",\"" + sub3prino + "\",\"" + sub3altcc + "\",\"" + sub3altno + "\",\"" + sub4pricc + "\",\"" + sub4prino + "\",\"" + sub4altcc + "\",\"" + sub4altno + "\",\"" + pricc + "\",\"" + prino + "\",\"" + prialtcc + "\",\"" + prialtno + "\",\"" + seccc + "\",\"" + secno + "\",\"" + secaltcc + "\",\"" + secaltno + "\"],";
    ...
    public static string LoadSubProfile4Data()
    {
        ...
        while (reader.Read())
        {
            ...
            string fname = reader.GetString(1);
            string lname = reader.GetString(2);
            string dob = Convert.ToDateTime(reader["Sub_Profile4_DOB"]).ToString("yyyy-MM-dd");
            string nationality = reader.GetString(4);
            string country = reader.GetString(5);
            int age = reader.GetInt32(6);
    ...
    public static string LoadSubProfile1Data()
    {
        ...
        while (reader.Read())
        {
            ...
            string fname = reader.GetString(1);
            string lname = reader.GetString(2);
            string dob = Convert.ToDateTime(reader["Sub_Profile1_DOB"]).ToString("yyyy-MM-dd");
            string nationality = reader.GetString(4);
            string country = reader.GetString(5);
    ...
    public static string LoadSubProfile2Data()
    {
        ...
        while (reader.Read())
        {
            ...
            string fname = reader.GetString(1);
            string lname = reader.GetString(2);
            string dob = Convert.ToDateTime(reader["Sub_Profile2_DOB"]).ToString("yyyy-MM-dd");
            string nationality = reader.GetString(4);
            string country = reader.GetString(5);
            string age = reader.GetString(6);
    ...
    public static string LoadStayDetails()
    {
        ...
        while (reader.Read())
        {
            ...
            string arrival = Convert.ToDateTime(reader["Profile_Stay_Arrival_Date"]).ToString("yyyy-MM-dd");
            string depature= Convert.ToDateTime(reader["Profile_Stay_Departure_Date"]).ToString("yyyy-MM-dd");
            string salesRep = reader.GetString(4);
            string guestStatus = reader.GetString(5);
            string tourdate= Convert.ToDateTime(reader["Tour_Details_Tour_Date"]).ToString("yyyy-MM-dd");
    ...
    public static string LoadSecondaryData()
    {
        ...
        while (reader.Read())
        {
            ...
            string fname = reader.GetString(1);
            string lname = reader.GetString(2);
            string dob = Convert.ToDateTime(reader["Profile_Secondary_DOB"]).ToString("yyyy-MM-dd");
            string nationality = reader.GetString(4);
            string country = reader.GetString(5);
            string age = reader.GetString(6);
    ...
    public static string LoadPrimaryData()
    {
        ...
        while (reader.Read())
        {
            ...
            string fname = reader.GetString(1);
            string lname = reader.GetString(2);
            string dob = Convert.ToDateTime(reader["Profile_Primary_DOB"]).ToString("yyyy-MM-dd");
            string nationality = reader.GetString(4);
            string country = reader.GetString(5);
            string age = reader.GetString(6);
