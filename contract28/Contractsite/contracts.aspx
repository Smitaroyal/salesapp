...
#myBtn:hover {
  background-color: #555;
   ...
   #cleft {
     ...
     #ffractional1,#tfractional,#tpoints,#TextFDepo2,#TextFBala2,#TextFDepo1,#TextFBala1,#TextBox96,#TextICE,#TextHP,#texttest,#texte,#remarkP,#Button3,#PointsAdd,#TPAdd,#remarkTP,#hiddentconttype,#hiddentconttype2{
         /*float:left;*/
         display:none;
     }
...
.grid-container{
  ...
  padding: 10px;
  grid-template-areas:
    'item1 item1 item1 item2 item3 item3 item3'
 ...
 <label for="chsp5">SUB PROFILE 4</label>      
                ...
                <table cellpadding="5px" cellspacing="5px">
                   ...
                   <div id="FracFina">
                        <div class="grid-FFinaContainer">
                            ...
                            <div class="itemFFC3">
                               <asp:TextBox ID="TotalPurTextBoxFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox> 
                            </div>
                            <div class="itemFFC4">
                                <p>Qualifying Deposit</p>
                            </div>
                            <div class="itemFFC5">
                                <asp:TextBox ID="QualTextBoxFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemFFC6">
                                <p>Amount of Credit</p>
                            </div>
                            <div class="itemFFC7">
                                <asp:TextBox ID="AmountCreditTextBoxFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemFFC8">
                                <p>Credit Amount in Curr</p>
                            </div>
                                  <div class="itemFFC9">
                                <asp:TextBox ID="AmountCreditCurrTextBoxFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemFFC10">
                                <p>No. of Months</p>
                            </div>
                            <div class="itemFFC11">
                               <asp:TextBox ID="NoMonthsTextBoxFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemFFC12">
                                <p>Rate of Interset</p>
                            </div>
                            <div class="itemFFC13">
                               <asp:TextBox ID="RateInterestTextBoxFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemFFC14">
                                <p>Monthly Repayment</p>
                            </div>
                            <div class="itemFFC15">
                                <asp:TextBox ID="MonthRepayTextBoxFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemFFC16">
                ...
                <table cellpadding="5px" cellspacing="5px">
                  ...
                  <div id="PFina">
                      <div class="grid-PFinaContainer">
                            ...
                            <div class="itemPFC3">
                               <asp:TextBox ID="TotalPurTextBoxPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox> 
                            </div>
                            <div class="itemPFC4">
                                <p>Qualifying Deposit</p>
                            </div>
                            <div class="itemPFC5">
                                <asp:TextBox ID="QualTextBoxPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemPFC6">
                                <p>Amount of Credit</p>
                            </div>
                            <div class="itemPFC7">
                                <asp:TextBox ID="AmountCreditTextBoxPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemPFC8">
                                <p>Credit Amount in Curr</p>
                            </div>
                                  <div class="itemPFC9">
                                <asp:TextBox ID="AmountCreditCurrTextBoxPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemPFC10">
                                <p>No. of Months</p>
                            </div>
                            <div class="itemPFC11">
                               <asp:TextBox ID="NoMonthsTextBoxPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemPFC12">
                                <p>Rate of Interset</p>
                            </div>
                            <div class="itemPFC13">
                               <asp:TextBox ID="RateInterestTextBoxPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemPFC14">
                                <p>Monthly Repayment</p>
                            </div>
                            <div class="itemPFC15">
                                <asp:TextBox ID="MonthRepayTextBoxPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemPFC16">
                ...
                <table  cellpadding="5px" cellspacing="5px">
                  ...
                  <div id="TFFina">
                         <div class="grid-TFFinaContainer">
                            ...
                            <div class="itemTFFC3">
                               <asp:TextBox ID="TotalPurTextBoxTFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox> 
                            </div>
                            <div class="itemTFFC4">
                                <p>Qualifying Deposit</p>
                            </div>
                            <div class="itemTFFC5">
                                <asp:TextBox ID="QualTextBoxTFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTFFC6">
                                <p>Amount of Credit</p>
                            </div>
                            <div class="itemTFFC7">
                                <asp:TextBox ID="AmountCreditTextBoxTFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTFFC8">
                                <p>Credit Amount in Curr</p>
                            </div>
                            <div class="itemTFFC9">
                             <asp:TextBox ID="AmountCreditCurrTextBoxTFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTFFC10">
                                <p>No. of Months</p>
                            </div>
                            <div class="itemTFFC11">
                               <asp:TextBox ID="NoMonthsTextBoxTFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTFFC12">
                                <p>Rate of Interset</p>
                            </div>
                            <div class="itemTFFC13">
                               <asp:TextBox ID="RateInterestTextBoxTFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTFFC14">
                                <p>Monthly Repayment</p>
                            </div>
                            <div class="itemTFFC15">
                                <asp:TextBox ID="MonthRepayTextBoxTFFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                ...
                <table cellpadding="5px" cellspacing="5px">
                   ...
                   <div id="TPFina">
                     <div class="grid-TPFinaContainer">
                            ...
                            <div class="itemTPFC3">
                               <asp:TextBox ID="TotalPurTextBoxTPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox> 
                            </div>
                            <div class="itemTPFC4">
                                <p>Qualifying Deposit</p>
                            </div>
                            <div class="itemTPFC5">
                                <asp:TextBox ID="QualTextBoxTPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTPFC6">
                                <p>Amount of Credit</p>
                            </div>
                            <div class="itemTPFC7">
                                <asp:TextBox ID="AmountCreditTextBoxTPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTPFC8">
                                <p>Credit Amount in Curr</p>
                            </div>
                                  <div class="itemTPFC9">
                                <asp:TextBox ID="AmountCreditCurrTextBoxTPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTPFC10">
                                <p>No. of Months</p>
                            </div>
                            <div class="itemTPFC11">
                               <asp:TextBox ID="NoMonthsTextBoxTPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTPFC12">
                                <p>Rate of Interset</p>
                            </div>
                            <div class="itemTPFC13">
                               <asp:TextBox ID="RateInterestTextBoxTPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
                            <div class="itemTPFC14">
                                <p>Monthly Repayment</p>
                            </div>
                            <div class="itemTPFC15">
                                <asp:TextBox ID="MonthRepayTextBoxTPFC" runat="server" Enabled="True" Width="200px" ></asp:TextBox>
                            </div>
  ...
  <!-- Modal content -->
                    ...
                    <div id="ch"></div>
                        ...
                        <asp:Button ID="Button8" runat="server" Text="print" OnClientClick="print();displayI();return false;" />&nbsp;&nbsp;&nbsp;&nbsp<input id="t45" type="text" name="ter"  /> 
                        <br />
                        <br />
                        <br />
              ...
              <div id="remarks">
                  ...
                  <tr>
                      ...
                      <td><asp:Label ID="Label142" runat="server" Text="Label">AUD Rate</asp:Label> &nbsp;&nbsp;<asp:TextBox ID="TextAusRateP" runat="server" Enabled="True" Width="150px"></asp:TextBox></td>
