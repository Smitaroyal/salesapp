...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  $(function () {
      $("#pdobdatepicker,#sdobdatepicker,#sp1dobdatepicker,#sp2dobdatepicker,#checkindatedatepicker,#checkoutdatedatepicker,#tourdatedatepicker,#SubP3DOB,#SubP4DOB").datepicker({
          changeMonth: true,
          changeYear: true,
          yearRange: "-100:+0",
          dateFormat: 'yy-mm-dd'
...
.grid-container{
  ...
  padding: 10px;
  grid-template-areas:
    'item1 item1 item2 item3 . item3a'
