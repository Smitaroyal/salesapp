...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
         ...
         cityTextBox.Text = ds.Tables[0].Rows[0]["Profile_Address_city"].ToString();
            ...
            SubP4CCDropDownList.DataSource = dssp3;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string sp3nationality = SubP3NationalityDropDownList.SelectedItem.Text; //Request.Form[SubP3NationalityDropDownList.UniqueID];
