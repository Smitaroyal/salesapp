...
#myBtn:hover {
  background-color: #555;
    ...
    #panel,#chs2,#chs3,#panel2,#chsp4,#panel3,#chsp5,#panel4 {
        display: none;
    }
    #TextBox22 {
        vertical-align: top;
       ...
       <div id="pro1" style="background-color:#e9e9e9;padding-top:10px;padding-left:5px;padding-right:5px;">
        ...
        <asp:DropDownList ID="VenueDropDownList" runat="server" Width="150px"></asp:DropDownList>
             ...
             <div class="item5a">                   
                       ...
                       <p class="help_text_style">Venue2</p>
                ...
                <div class="grid-container20">
                   ...
                   <%-- <div class="item203">
                    ...
                    <div class="item2011">
                     ...
                     <div class="item2012">
                       <input id="chs4" type="checkbox" onclick="shows4();"/><label id="yes" style="color:forestgreen">YES</label><label id="no" style="color: red">NO</label>
                    </div>
