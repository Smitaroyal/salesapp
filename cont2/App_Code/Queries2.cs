...
public class Queries2
{
    ...
    public static int InsertPrimaryProfile(string Profile_Primary_ID, string Profile_Primary_Title, string Profile_Primary_Fname, string Profile_Primary_Lname, string Profile_Primary_DOB, string Profile_Primary_Nationality, string Profile_Primary_Country, string Profile_ID)
    {
        int rowsAffected = 0;
        SqlDataAdapter da = new SqlDataAdapter();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Profile_Primary values(@Profile_Primary_ID,	@Profile_Primary_Title,	@Profile_Primary_Fname,	@Profile_Primary_Lname,	@Profile_Primary_DOB,@Profile_Primary_Nationality,@Profile_Primary_Country,@Profile_ID)", cs1);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error in insert Profile_Primary Query " + ex.Message);
    ...
    public static int InsertSecondaryProfile(string Profile_Secondary_ID, string Profile_Secondary_Title, string Profile_Secondary_Fname, string Profile_Secondary_Lname, string Profile_Secondary_DOB, string Profile_Secondary_Nationality, string Profile_Secondary_Country, string Profile_ID)
    {
        int rowsAffected = 0;
        SqlDataAdapter da = new SqlDataAdapter();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Profile_Secondary values(@Profile_Secondary_ID, 	@Profile_Secondary_Title,@Profile_Secondary_Fname,@Profile_Secondary_Lname,@Profile_Secondary_DOB,@Profile_Secondary_Nationality,@Profile_Secondary_Country,@Profile_ID)", cs1);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error in insert Profile_Secondary Query " + ex.Message);
    ...
    public static int InsertSub_Profile1(string Sub_Profile1_ID, string Sub_Profile1_Title, string Sub_Profile1_Fname, string Sub_Profile1_Lname, string Sub_Profile1_DOB, string Sub_Profile1_Nationality, string Sub_Profile1_Country, string Profile_ID)
    {
        int rowsAffected = 0;
        SqlDataAdapter da = new SqlDataAdapter();
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Sub_Profile1 values(@Sub_Profile1_ID,@Sub_Profile1_Title ,	@Sub_Profile1_Fname ,	@Sub_Profile1_Lname ,	@Sub_Profile1_DOB ,	@Sub_Profile1_Nationality ,	@Sub_Profile1_Country,	@Profile_ID)", cs1);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error in insert Sub_Profile1 Query " + ex.Message);
    ...
    public static int InsertSub_Profile2(string Sub_Profile2_ID, string Sub_Profile2_Title, string Sub_Profile2_Fname, string Sub_Profile2_Lname, string Sub_Profile2_DOB, string Sub_Profile2_Nationality, string Sub_Profile2_Country, string Profile_ID)
    {
        int rowsAffected = 0;
        SqlDataAdapter da = new SqlDataAdapter();
        using (SqlConnection cs2 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Sub_Profile2 values(@Sub_Profile2_ID,@Sub_Profile2_Title ,	@Sub_Profile2_Fname ,	@Sub_Profile2_Lname ,	@Sub_Profile2_DOB ,	@Sub_Profile2_Nationality ,	@Sub_Profile2_Country,	@Profile_ID)", cs2);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error in insert Sub_Profile2 Query " + ex.Message);
    ...
    public static int InsertProfileStay(string Profile_Stay_ID, string Profile_Stay_Resort_Name, string Profile_Stay_Resort_Room_Number, string Profile_Stay_Arrival_Date, string Profile_Stay_Departure_Date, string Profile_ID)
    {
        ...
        using (SqlConnection cs2 = Queries.GetDBConnection())
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error in insert Profile_Stay Query " + ex.Message);
    ...
    public static int InsertTourDetails(string Tour_Details_ID, string Tour_Details_Guest_Status, string Tour_Details_Guest_Sales_Rep, string Tour_Details_Tour_Date, string Tour_Details_Sales_Deck_Check_In, string Tour_Details_Sales_Deck_Check_Out, string Tour_Details_Taxi_In_Price, string Tour_Details_Taxi_In_Ref, string Tour_Details_Taxi_Out_Price, string Tour_Details_Taxi_Out_Ref, string Profile_ID)
    {
        ...
        using (SqlConnection cs2 = Queries.GetDBConnection())
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error in insert Tour_Details Query " + ex.Message);
   ...
   /* public static DataSet LoadProfileOnCreation(string profileid)
    ...
    public static DataSet LoadProfileOnCreation(string profileid)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select p.Profile_ID,CONVERT(CHAR(10),p.Profile_Date_Of_Insertion,120) as Profile_Date_Of_Insertion,	p.Profile_Created_By,	p.Profile_Venue_Country,	p.Profile_Venue,	p.Profile_Group_Venue,	p.Profile_Marketing_Program,	p.Profile_Agent,	p.Profile_Agent_Code,	p.Profile_Member_Type1,	p.Profile_Member_Number1,	p.Profile_Member_Type2,	p.Profile_Member_Number2,	p.Profile_Employment_status,	p.Profile_Marital_status,	p.Profile_NOY_Living_as_couple,	p.Office,	p.Comments,pp.Profile_Primary_ID,	pp.Profile_Primary_Title,	pp.Profile_Primary_Fname,	pp.Profile_Primary_Lname, CONVERT(CHAR(10),pp.Profile_Primary_DOB,120) as Profile_Primary_DOB	,	pp.Profile_Primary_Nationality,	pp.Profile_Primary_Country,ps.Profile_Secondary_ID,	ps.Profile_Secondary_Title,	ps.Profile_Secondary_Fname,	ps.Profile_Secondary_Lname,CONVERT(CHAR(10),ps.Profile_Secondary_DOB,120) as Profile_Secondary_DOB	,	ps.Profile_Secondary_Nationality,	ps.Profile_Secondary_Country,sp1.Sub_Profile1_ID,	sp1.Sub_Profile1_Title,	sp1.Sub_Profile1_Fname,	sp1.Sub_Profile1_Lname,	sp1.Sub_Profile1_DOB,	sp1.Sub_Profile1_Nationality,	sp1.Sub_Profile1_Country,sp2.Sub_Profile2_ID,	sp2.Sub_Profile2_Title,	sp2.Sub_Profile2_Fname,	sp2.Sub_Profile2_Lname,	sp2.Sub_Profile2_DOB,	sp2.Sub_Profile2_Nationality,	sp2.Sub_Profile2_Country,ph.Phone_ID,	ph.Primary_CC,	ph.Primary_Mobile,	ph.Primary_Alt_CC,	ph.Primary_Alternate,	ph.Secondary_CC,	ph.Secondary_Mobile,	ph.Secondary_Alt_CC,	ph.Secondary_Alternate,	ph.Subprofile1_CC,	ph.Subprofile1_Mobile,	ph.Subprofile1_Alt_CC,	ph.Subprofile1_Alternate,	ph.Subprofile2_CC,	ph.Subprofile2_Mobile,	ph.Subprofile2_Alt_CC,	ph.Subprofile2_Alternate,e.Email_ID,	e.Primary_Email,	e.Secondary_Email,	e.Subprofile1_Email,	e.Subprofile2_Email,pa.Profile_Address_ID,	pa.Profile_Address_Line1,	pa.Profile_Address_Line2,	pa.Profile_Address_State,	pa.Profile_Address_city,pa.Profile_Address_Country,	pa.Profile_Address_Postcode,s.Profile_Stay_ID,	s.Profile_Stay_Resort_Name,	s.Profile_Stay_Resort_Room_Number,	s.Profile_Stay_Arrival_Date,	s.Profile_Stay_Departure_Date,td.tour_Details_ID,	td.Tour_Details_Guest_Status,	td.Tour_Details_Guest_Sales_Rep,	td.Tour_Details_Tour_Date,	td.Tour_Details_Sales_Deck_Check_In,	td.Tour_Details_Sales_Deck_Check_Out,	td.Tour_Details_Taxi_In_Price,	td.Tour_Details_Taxi_In_Ref,	td.Tour_Details_Taxi_Out_Price,	td.Tour_Details_Taxi_Out_Ref from Profile p left join Profile_Primary pp on pp.Profile_ID = p.Profile_ID left join Profile_Secondary ps on ps.Profile_ID = p.Profile_ID left join Sub_Profile1 sp1 on sp1.Profile_ID = p.Profile_ID left join Sub_Profile2 sp2 on sp2.Profile_ID = p.Profile_ID left join Phone ph on ph.Profile_ID = p.Profile_ID left join Email e on e.Profile_ID = p.Profile_ID left join Profile_Address pa on pa.Profile_ID = p.Profile_ID left join Profile_Stay s on s.Profile_ID = p.Profile_ID left join Gift g on g.Profile_ID = p.Profile_ID left join Tour_Details td on td.Profile_ID =p.Profile_ID where p.Profile_ID =@profileid", cs1);
            SqlCmd.Parameters.Add("@profileid", SqlDbType.VarChar).Value = profileid;
            da = new SqlDataAdapter(SqlCmd);
            ds = new DataSet();
            da.Fill(ds);
    ...
    public static DataSet LoadPrintFiles(string conttype,string office)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select p.Printpdf_name from ContractType a,printpdf p where a.contracttype_id = p.contracttype_id and a.ContractType_name = @ContractType_name and p.Printpdf_office=@Printpdf_office", cs1);
    ...
    public static int InserPurchaseService(string PS_ID, string PS_Deposit_Pay_Method, string PS_Deposit, string PS_Deposit_PA, string PS_Deposit_SA, string PS_PA_Admission, string PS_SA_Application, string PS_PA_Administration, string PS_SA_Administration, string PS_Total_Purchase, string PS_Total_Service, string PS_Country_Tax, string PS_Grand_Total, string PS_PA_Balance_Due, string PS_SA_Balance_Due, string PS_PA_No_Install, string PS_SA_No_Install, string PS_PA_FInstall_Date, string PS_SA_FInstall_Date, string PS_PA_Install_Amt, string PS_SA_Install_Amt, string PS_PA_FInstall_Amt, string PS_SA_FInstall_Amt, string PS_PA_Balance_Due_Dates, string PS_SA_Balance_Due_Dates, string PS_Remarks, string PS_EURO_Rate, string PS_AUS_Rate, string PS_GBP_Rate, string PS_IDA_Rate, string PS_Pay_Protect, string PS_YOInterest, string Profile_ID, string Contract_Finance_ID, string Total_Balance, DateTime PS_Date_Of_Insert, string office)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                da.InsertCommand = new SqlCommand("insert into Purchase_Service values(@PS_ID,	@PS_Deposit_Pay_Method,	@PS_Deposit,	@PS_Deposit_PA,	@PS_Deposit_SA,	@PS_PA_Admission,	@PS_SA_Application,	@PS_PA_Administration,	@PS_SA_Administration,	@PS_Total_Purchase,	@PS_Total_Service,	@PS_Country_Tax,	@PS_Grand_Total,	@PS_PA_Balance_Due,	@PS_SA_Balance_Due,	@PS_PA_No_Install,	@PS_SA_No_Install,	@PS_PA_FInstall_Date,	@PS_SA_FInstall_Date,	@PS_PA_Install_Amt,	@PS_SA_Install_Amt,	@PS_PA_FInstall_Amt,	@PS_SA_FInstall_Amt,	@PS_PA_Balance_Due_Dates,	@PS_SA_Balance_Due_Dates,	@PS_Remarks,	@PS_EURO_Rate,	@PS_AUS_Rate,	@PS_GBP_Rate,	@PS_IDA_Rate,	@PS_Pay_Protect,	@PS_YOInterest,	@Profile_ID,	@Contract_Finance_ID, @Total_Balance,@PS_Date_Of_Insert)", cs1);
    ...
    public static int InsertFinanceInv(string Finance_Invoice_Numb, string Finance_Invoice_Desc, string Finance_Invoice_Due_Date, string Finance_Invoice_Amt, string Finance_Invoice_currency, string Finance_Invoice_Contratct_Numb, string Profile_ID, string Finance_Invoice_Type, string office)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                da.InsertCommand = new SqlCommand("insert into Finance_Invoice values(@Finance_Invoice_Numb,	@Finance_Invoice_Desc,	@Finance_Invoice_Due_Date,	@Finance_Invoice_Amt,	@Finance_Invoice_currency,	@Finance_Invoice_Contratct_Numb,	@Profile_ID, @Finance_Invoice_Type)", cs1);
    ...
    public static string LoadPointCont(string office,string club_name,string venuecountry, string venue, string mark)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select Contract_Code from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)and Venue_ID in (select Venue_ID from venue where Venue_Name = @venue)", cs1);
            SqlCmd.Parameters.Add("@office", SqlDbType.VarChar).Value = office;
            ...
            SqlCommand SqlCmd5 = new SqlCommand("select Increment_Value from Contract_Club where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)and Venue_ID in (select Venue_ID from venue where Venue_Name = @venue)", cs1);
    ...
    public static int UpdatePointCont(string office, string club_name, string venuecountry, string venue, string mark)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand SqlCmd6 = new SqlCommand("update Contract_Club set Increment_Value = '" + incr3 + "' where Contract_Club_Name=@club_name and Office=@office and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name=@venuecountry)and Venue_ID in (select Venue_ID from venue where Venue_Name = @venue)", cs1);
    ...
    public static int UpdateFracCont( string venuecountry, string venue, string mark)
    {
        ...
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            try
            {
                ...
                SqlCommand SqlCmd6 = new SqlCommand("update Marketing_Program set ContF_Inc_Val = '" + id + "' where Venue_Group_ID in (select Venue_Group_ID from Venue_Group where Venue_ID in (select Venue_ID from venue where Venue_Name = @venue and Venue_Country_ID in (select Venue_Country_ID from VenueCountry where Venue_Country_Name = @venuecountry)) )  and Marketing_Program_Name = @mark", cs1);
    ...
    public static string LoadPropfess(string NoPoints)
    {
       ...
       // string [] sendvalArray = new string[3];
        using (SqlConnection cs1 = Queries.GetDBConnection())
        {
            SqlCommand SqlCmd = new SqlCommand("select charge_Property_fee_per_year from Property_fee_charge where charge_year = year(GETDATE()) and charge_No_Of_Points = @Nopoints", cs1);
            SqlCmd.Parameters.Add("@Nopoints", SqlDbType.VarChar).Value = NoPoints;

            sendval1 = (double)SqlCmd.ExecuteScalar();

            SqlCommand SqlCmd2 = new SqlCommand("select charge_member_fee from Property_fee_charge where charge_year = year(GETDATE()) and charge_No_Of_Points = @Nopoints", cs1);
